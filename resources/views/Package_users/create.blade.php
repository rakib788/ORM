                    ...
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right">
                                <a href="{{ route('package_user.index') }}" class="btn btn-sm btn-success">All Package-user</a>
                            </div>
                        </div>
                    </div>

                <div class="card-body">
                    <form action="{{ route('package_user.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
